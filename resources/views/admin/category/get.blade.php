...
font-size: 16px;">  <a href="{{url('home')}}" class="btn btn-danger square-btn-adjust">Logout</a> </div>
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                      ...
                      <li  >
                        <a  href="{{url('admin/category')}}"class="active-menu"><i class="fa fa-table fa-3x"></i>category</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper"> 
            <div id="page-inner">
                <a class="btn btn-primary" href="{{url('admin/category/add')}}">Tambah Category</a>
                <div class="row">
                    <div class="col-md-12">
                     <h2>Data Category</h2>  
                        <table class="table table-striped">
                            ...
                            <tr>
                                <td>{{$cat->nama}}</td>
                                <td>
                                <a href="{{url('admin/category')}}/{{$cat->id}}" class="btn btn-info">Edit</a>
                                 <a href="{{url('admin/category/hapus')}}/{{$cat->id}}" class="btn btn-danger">Hapus</a> 
