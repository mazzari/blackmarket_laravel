...
font-size: 16px;"> <a href="../login" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper"> 
            <div id="page-inner">
                <a class="btn btn-primary" href="{{url('admin/barang/add')}}">Tambah barang</a>
                <div class="row">
                    <div class="col-md-12">
                     <h2>Data Barang</h2>  
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td>{{$barang->detail}}</td>
                                <td>{{$barang->stock}}</td>
                                 <td>{{$barang->category_barang_id}}</td>   
                                <td>
                                <a href="{{url('admin/barang')}}/{{$barang->id}}" class="btn btn-info">Edit</a>
                                 <a href="{{url('admin/barang/hapus')}}/{{$barang->id}}" class="btn btn-danger">Hapus</a> 
